...
var form = document.querySelector('#booknow-form');
...
function formValidation(theForm){
	...
	function isFieldValid(field){
		...
		if (field.name === "fullname" && field.min > 0 && field.value < parseInt(field.min)) {
			errorMessage = "Must be atleast " + field.min + " or greater.";
		}
...
function formValidation(theForm){
	...
	function isFieldValid(field){
		...
		var errorSpan = document.querySelector("#" + field.id + "-error");
		errorSpan.innerHTML = "";
		errorSpan.classList.remove("warning1");


		if (field.name === "fullname1" && field.min > 0 && field.value < parseInt(field.min)) {
			errorMessage = "Must be atleast " + field.min + " or greater.";
		}
		...
		if (field.type === "email1" && ! isEmail(field.value)) {
		...
		if (errorMessage !== "") {
			...
			var errorSpan = document.querySelector("#" + field.id + "-error1");
			errorSpan.innerHTML = errorMessage;
			errorSpan.classList.add("warning");
